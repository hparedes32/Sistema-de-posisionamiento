...
if($reg=mysqli_fetch_array($registros)){
	...
	mysqli_query($conexion,"Delete from Cocinero where Cocinero.DNI=$reg[DNI]");
	mysqli_query($conexion,"Delete from Ayudante where Ayudante.DNI=$reg[DNI]");
	mysqli_query($conexion,"Delete from Trabajadores where Trabajadores.DNI=$reg[DNI]")or die("<strong><font color=\"white\" size=\"5\">No se pudo dar de baja</font></strong>". mysqli_error($conexion));
	
	echo "<strong><font color=\"white\" size=\"5\">EL EMPLEADO SE DIO DE BAJA EXITOSAMENTE </font></strong>";
	}
else{
 echo "<strong><font color=\"white\" size=\"5\">NO EXISTE ESE EMPLEADO</font></strong>";
 }	
